    ...
    <div className="page-home">
      <div className="page-home_section_1">
        <div className=" bg-orange-200 w-screen">
          ...
          <div className="flex justify-center card-import">
      ...
      <div className="page-home_section_3">
        <div className=" bg-green-50">
          <div className="page-home_section_3_content">
            ...
            <div className="basecuad grid items-center grid-cols-3 text-5xl gap-40 px-40 pt-20 pb-10">
            ...
            <button className="bg-green-300  hover:bg-gray-100 text-2xl text-gray-800 font-bold px-10 py-6 border border-gray-400 rounded shadow">
